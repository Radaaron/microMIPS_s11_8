...
public class PipelineHandler {
	...
	public CodeObject stall(CodeObject codeObject) {
		// stalls by replacing the current IF values with the current ID values and decrementing program counter
		...
		codeObject.setPipelineRegisterValue(0, codeObject.getPipelineBufferValue(0));
		codeObject.setPipelineRegisterValue(1, codeObject.getPipelineBufferValue(1));
	...
	public CodeObject WBstage(CodeObject codeObject) {
		...
		if(((String) codeObject.getPipelineBufferValue(10)).equals("N/A")) {
			...
			if(((String) codeObject.getPipelineBufferValue(1)).equals("N/A") && codeObject.isStarted() 
					&& ((String) codeObject.getPipelineBufferValue(15)).equals("0")
					&& ((String) codeObject.getPipelineBufferValue(16)).equals("0") 
					&& ((String) codeObject.getPipelineBufferValue(17)).equals("0") 
					&& ((String) codeObject.getPipelineBufferValue(18)).equals("0")) {
